...
rcxDict.prototype = {
	...
	fileReadArray: function(name, charset) {
		var a = fs.readFileSync(name, charset).split('\n');
	...
	loadDictionary: function() {
		...
		this.wordDict = fs.readFileSync("data/dict.dat", 'UTF-8');
		this.wordIndex = fs.readFileSync("data/dict.idx", 'UTF-8');
		this.kanjiData = fs.readFileSync("data/kanji.dat", 'UTF-8');
